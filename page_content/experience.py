    ...
    projects = [
        {
            ...
            "description": "The project aimed to enhance Xiaohongshu's recognition and market share in Hong Kong by conducting user research to gather key insights for market strategies. Content analysis utilized big data to understand user behavior patterns and optimize content direction. Creative marketing activities, combined with merchant collaborations and offline advertising, successfully encouraged users to download Xiaohongshu, with an expected online exposure of over 500,000. ",
